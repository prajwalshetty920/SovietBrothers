...
//       emailjs
//         .send(
//           "service_xxxxx", // replace later
//           "template_xxxxx", // replace later
//           {
//             name: form.name,
//             email: form.email,
//             phone: form.phone,
...
//           },
//           "public_key_xxxxx", // replace later
//         )
//         .then(() => {
//           setSubmitted(true);
...
//     //   icon: <FaShieldAlt />,
//     //   label: "SOC Hotline",
//     //   val: "+91 1800-SECURE-24",
//     // },
//   ];

//   return (
//     <div id="contact" className="py-24 px-6 bg-gray-950/50">
...
//                   hover:from-blue-500 hover:to-cyan-500 shadow-lg
